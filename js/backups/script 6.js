...
// error, a biorep must be specified
   ...
   $('#btnResetExpStructCoord').on("click", function () {
	  ...
	  // $.each(my_rows, function (idx, cur_row) {
		  // // $(trs[my_D_table.row(cur_row).index()]).addClass('rawfiles_tbl_td_selected');
		  // console.log(cur_row);
		  // // console.log($('#rawfiles_tbl_allfiles tbody tr').index(this));
		  // var my_tmp = cur_row["DT_RowId"];
		  // console.log("/" + my_tmp + "/");
		  // console.log(document.getElementById("tr_D140509_015_140513063317.raw"));
